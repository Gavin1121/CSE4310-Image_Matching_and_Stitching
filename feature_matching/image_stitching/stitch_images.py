...
def compute_affine_transform(src_points: np.ndarray, dst_points: np.ndarray) -> np.ndarray:
    """Computing the affine transformation matrix from src_points to dst_points.
...
def compute_projective_transform(src_points: np.ndarray, dst_points: np.ndarray) -> np.ndarray:
    """Computing the projective transformation matrix from src_points to dst_points.
...
def ransac(  # noqa: PLR0917, PLR0913
...
def plot_best_matches(  # noqa: PLR0913, PLR0917
    src_img: np.ndarray,
    dst_img: np.ndarray,
